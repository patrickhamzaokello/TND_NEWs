...
class Command(BaseCommand):
    help = "Scrape articles from ChimpReports"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--news-url",
            default=None,
            help="Override the ChimpReports listing URL.",
        )
        parser.add_argument(
            "--no-full-content",
            action="store_true",
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Starting ChimpReports scraper..."))
        ...
        try:
            ...
            raise CommandError(f"ChimpReports scraping failed: {exc}") from exc
