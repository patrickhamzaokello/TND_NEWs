...
class ChimpReportsSCrapper:

    def __init__(self, source_name="ChimpReports"):
        try:
            self.source = NewsSource.objects.get(name=source_name)
        except NewsSource.DoesNotExist:
            self.source = NewsSource.objects.create(
                name=source_name,
                base_url="https://chimpreports.com",
                news_url="https://chimpreports.com/category/news/"
            )
