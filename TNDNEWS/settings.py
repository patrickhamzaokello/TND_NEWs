...
APPLE_CLIENT_ID = "com.newsapi.mwonya"
...
ALLOW_UNVERIFIED_LOGIN = config('ALLOW_UNVERIFIED_LOGIN', default=False, cast=bool)
...
STATIC_URL = "/static/"
STATICFILES_DIRS =  [BASE_DIR / 'tndnews_static']
